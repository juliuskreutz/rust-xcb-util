...
pub fn set_wm_name_checked<T: AsRef<str>>(
    ...
    void!(checked -> c,
		xcb_icccm_set_wm_name_checked(c.get_raw_conn(), window, x::Atom_STRING, 8,
...
pub fn set_wm_colormap_windows<'a>(
    c: &'a xcb::Connection,
    window: x::Window,
...
pub fn set_wm_colormap_windows_checked<'a>(
    c: &'a xcb::Connection,
    window: x::Window,
    colormap_windows: x::Atom,
    list: &[x::Window],
...
pub fn set_wm_size_hints_checked<'a>(
    c: &'a xcb::Connection,
    window: x::Window,
    property: x::Atom,
    hints: &SizeHints,
...
pub fn set_wm_normal_hints_checked<'a>(
    c: &'a xcb::Connection,
    window: x::Window,
    hints: &SizeHints,
) -> xcb::VoidCookie<'a> {
...
pub fn set_wm_protocols_checked<'a>(
    c: &'a xcb::Connection,
    window: x::Window,
    protocols: x::Atom,
    list: &[x::Window],
