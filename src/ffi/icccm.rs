...
pub const XCB_ICCCM_WM_ALL_HINTS: xcb_icccm_wm_t = XCB_ICCCM_WM_HINT_INPUT
...
extern "C" {
    ...
    pub fn xcb_icccm_get_wm_transient_for_reply(
        c: *mut xcb_connection_t,
        cookie: xcb_get_property_reply_t,
        prop: *mut xcb_window_t,
        e: *mut *mut xcb_generic_error_t,
    ) -> u8;
    ...
    pub fn xcb_icccm_set_wm_hints_checked(
        c: *mut xcb_connection_t,
        window: xcb_window_t,
        hints: *const xcb_icccm_wm_hints_t,
    ) -> xcb_void_cookie_t;
